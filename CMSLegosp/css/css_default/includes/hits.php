...
*********************************************************************************/
   ...
   $q = db_query("SELECT productID, ".PRODUCTS_TABLE.".name, Price, ".PRODUCTS_TABLE.".picture, items_sold, ".PRODUCTS_TABLE.".hurl, ".CATEGORIES_TABLE.".enabled, customers_rating FROM ".PRODUCTS_TABLE." RIGHT JOIN ".CATEGORIES_TABLE." USING (categoryID) WHERE ".PRODUCTS_TABLE.".enabled='1' AND ".CATEGORIES_TABLE.".enabled='1' and ".PRODUCTS_TABLE.".picture!='' ORDER BY items_sold DESC LIMIT 0 , ".CONF_MAX_HITS) or die (db_error());
   $result = Array();
