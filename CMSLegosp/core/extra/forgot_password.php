 ...
 ****************************************************************************/
	...
	//DO NOT KEEP THIS FILE ON YOUR SERVER IN THE LEGOSP - http://legosp.net ROOT FOLDER !!

	session_start();

	if (!file_exists("./cfg/connect.inc.php"))
	{
		die ("Couldn't proceed!<br>Place this file into LEGOSP root folder");
	}
